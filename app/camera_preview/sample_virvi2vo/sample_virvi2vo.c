...
#if ISP_RUN
        result = AW_MPI_ISP_SwitchIspConfig(stContext.mConfigPara.mVIPP2VOConfigArray[i].mIspDev, stContext.mConfigPara.mIspWdrSetting);//切换图像效果（彩色、黑白），切换编译进固件的 ISP 效果参数。
        if(result != SUCCESS)
        {
